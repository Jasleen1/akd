...
use crate::{node_state::{NodeLabel, hash_label}, EMPTY_HASH, EMPTY_LABEL};
...
pub(crate) fn empty_node_hash_with_label<H: Hasher>() -> H::Digest {
    H::merge(&[H::hash(&EMPTY_HASH), hash_label::<H>(EMPTY_LABEL)])
}